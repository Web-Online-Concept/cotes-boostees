...
export default function PolitiqueConfidentialitePage() {
  return (
    <>
      <Head>
        <title>Politique de Confidentialité | Protection des Données RGPD Cotes-Boostées.com</title>
        <meta name="description" content="Politique de confidentialité et protection des données personnelles de Cotes-Boostées.com. Conformité RGPD, droits des utilisateurs." />
