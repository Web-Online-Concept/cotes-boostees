...
export default function CGVPage() {
  return (
    <>
      <Head>
        <title>CGV | Conditions Générales de Vente Cotes-Boostées.com</title>
        <meta name="description" content="Consultez les Conditions Générales de Vente de Cotes-Boostées.com : tarifs, abonnement, droits et obligations." />
